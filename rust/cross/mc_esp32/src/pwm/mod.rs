...
///
/// `timer_prescaler` = `160_000_000` / ([`PERIPHERAL_CLOCK_PRESCALER`] + 1) / ([`MAX_DUTY`] + 1) / [`FREQUENCY`] - 1
///
...
pub const MAX_DUTY: u16 = sc_messages::MAX_DUTY;

/// The current motor controller reads 5% of ([`MAX_DUTY`] + 1) as 0% power.
///
/// 5% of ([`MAX_DUTY`] + 1) = 3200
pub const STOP_DUTY: u16 = 3_200;
