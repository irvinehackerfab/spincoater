# Development Guide
This workspace contains a Nix dev shell for Rust on ESP32. 

The dev environment automatically installs the necessary tools for you.
If this dev enviornment is kept up to date, everyone who is using it will have tools that are up to date.
