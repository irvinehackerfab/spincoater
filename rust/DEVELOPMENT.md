...
This dev environment automatically installs the necessary tools for you and eliminates the possibility of missing system libraries on your PC as this project progresses. If this dev environment is kept up to date, everyone who is using it will have tools that are up to date.
...
The dev shell does not install any editors for you, but it does install rust-analyzer.
